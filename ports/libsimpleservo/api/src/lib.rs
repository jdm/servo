...
pub struct InitOptions {
    ...
    pub xr_discovery: Option<Box<dyn webxr_api::Discovery<SwapChains=webxr::SwapChains>>>,
...
struct ServoEmbedderCallbacks {
    waker: Box<dyn EventLoopWaker>,
    xr_discovery: Option<Box<dyn webxr_api::Discovery<SwapChains=webxr::SwapChains>>>,
...
impl EmbedderMethods for ServoEmbedderCallbacks {
    ...
    #[cfg(feature = "uwp")]
    fn register_webxr(&mut self, registry: &mut webxr_api::MainThreadRegistry<webxr::SwapChains>) {
