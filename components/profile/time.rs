...
impl Formattable for ProfilerCategory {
    ...
    fn format(&self) -> String {
        ...
        let name = match *self {
            ...
            ProfilerCategory::NetHostLookup => "Network Host Lookup",
            ProfilerCategory::NetHTTPRequestResponse => "Network HTTP Request/Response",
            ProfilerCategory::NetHTTPConnect => "Network HTTP Connect",
            ProfilerCategory::NetHTTPAwaitResponse => "Network HTTP Await Headers",
            ProfilerCategory::NetHTTPReceiveBody => "Network HTTP Receive Body",
