...
impl XRWebGLLayerMethods for XRWebGLLayer {
    ...
    fn Context(&self) -> XRWebGLRenderingContext {
        match self.context {
            RenderingContext::WebGL1(ref ctx) => XRWebGLRenderingContext::WebGLRenderingContext(DomRoot::from_ref(&**ctx)),
            RenderingContext::WebGL2(ref ctx) => XRWebGLRenderingContext::WebGL2RenderingContext(DomRoot::from_ref(&**ctx)),
        }
    }
