...
class CGInitAllStatics(CGAbstractMethod):
    ...
    def definition_body(self):
        return CGList([
            CGGeneric(f"    crate::codegen::GenericBindings::{toBindingModuleFileFromDescriptor(desc)}::{toBindingNamespace(desc.name)}"
                      "::init_statics::<D>();")
    ...
    def definition_body(self):
        return CGList([
            CGGeneric(f"proxy_handlers::{desc.name}.store(\n"
                      f"    crate::codegen::GenericBindings::{toBindingModuleFile(desc.name)}::{toBindingNamespace(desc.name)}"
